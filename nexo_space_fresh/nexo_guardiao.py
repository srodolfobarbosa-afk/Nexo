...
class NexoSwarm:
    ...
    def get_brain(self):
        ...
        self.key_idx += 1
        return ChatGroq(model_name="llama-3.3-70b-versatile", groq_api_key=key, temperature=0.5)
...
async def baixar_backup():
    ...
    try:
        ...
        return FileResponse(path=arquivo_zip, filename=os.path.basename(arquivo_zip), media_type='application/zip')
    except Exception as e:
